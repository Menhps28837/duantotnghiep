                    ...
                    <td class="text-center">
                        ...
                        @else
                            <form action="{{ route('donhang.destroy', $dh->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
                                <button type='submit' onclick="return confirm('Xác nhận xóa đơn hàng')" class="btn btn-danger btn-sm">
                                    Xóa
                                </button>
                            </form>
                        @endif
                    </td>
                    <td><a class="btn btn-primary btn-sm" href="{{ route('donhang.thanhtoanvaxacnhan', ['id' => $dh->id]) }}">Xác nhận nhận hàng</a>
                    </td>
